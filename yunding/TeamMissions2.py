...
def do_fation_task(cookie, userNo):
    game_gold = 0
    game_silver = 0
    game_copper = 0
    repair_num = 0
    ...
    while True:
        try:
            # cookie = 'token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJsb2dpbl9uYW1lIjoi5rS7552AMSIsImlkIjoiNWRmYzY2NmM3MmEyZmY1ODI5YWMyNWJiIiwiaWF0IjoxNTc2OTkxMTU3LCJleHAiOjE1Nzk1ODMxNTd9.95PcwSdQ-kOBrjC8A40aMsX7LYabCfBLctUw-W14RNQ'
            # 获取帮派任务
...
for cookie in cookies:
    # print('kkk')
    th = threading.Thread(target=do_fation_task, args=(cookie, userNo))
